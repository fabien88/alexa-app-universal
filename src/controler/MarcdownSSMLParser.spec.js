...
describe('parser', () => {
  ...
  it('sentences', () => {
    expect(
      ...
      '<speak> <p> hello <emphasis level="reduced"> coucou toto </emphasis> va ? </p> <p> <s> **oui jai bien dormi </s> <s> et toi** </s> <s> <emphasis level="moderate"> tu vas bien </emphasis> ? </s> </p> </speak>',
    );
  });
  it('emphasis', async () => {
    expect(
